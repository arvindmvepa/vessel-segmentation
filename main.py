...
if __name__ == '__main__':
    ...
    arg_index = 2
    objective_fn, tuning_constant, ss_r, regularizer_args, learning_rate_and_kwargs, op_fun_and_kwargs, weight_init, act_fn, hist_eq,clahe_kwargs,per_image_normalization,gamma,seq = zip(["wce","gdice", "ss"], [1.0,1.0,1.0], [.05,.05,.05], [None, ("L1",.000001),("L2",.000001)], [(.001, {}), (.001, {}),(.01, {'decay_steps': 1, 'decay_rate': .1})], [("adam",{}),("rmsprop",{}),("adadelta",{})], ["He", "Xnormal", "default"], ["lrelu", "relu", "relu"], [False, False, True], [None, {"clipLimit": 2.0, "tileGridSize": (8, 8)}, {"clipLimit": 2.0, "tileGridSize": (8, 8)}], [False, True, True], [None, 1.0, 5.0], [None, None, iaa.Sequential([iaa.Crop(px=(0, 16)), iaa.Fliplr(0.5),iaa.GaussianBlur(sigma=(0, 3.0))])])[arg_index]
