...
class StareDataset(DatasetWMasks):
    ...
    def __init__(self, batch_size=1, WRK_DIR_PATH ="./stare", TRAIN_SUBDIR="train", TEST_SUBDIR="test", sgd = True,
                 masks_provided=False, init_mask_imgs=True, mask_threshold=.1, cv_train_inds = None,
                 cv_test_inds = None, histo_eq=None, clahe_kwargs=None, per_image_normalization=False, gamma=None, **kwargs):
        super(StareDataset, self).__init__(batch_size=batch_size, WRK_DIR_PATH=WRK_DIR_PATH, TRAIN_SUBDIR=TRAIN_SUBDIR,
                                           ...
                                           histo_eq=histo_eq, clahe_kwargs=clahe_kwargs, per_image_normalization=per_image_normalization,
                                           gamma=gamma, **kwargs)
