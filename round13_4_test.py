...
if __name__ == '__main__':
    ...
    EXPERIMENTS_DIR_PATH = "/root/vessel-segmentation3/experiments13_4_test_eval"
    ...
    first_index = int(math.ceil(num_jobs/6.0))*3
    last_index = int(math.ceil(num_jobs/6.0))*4
