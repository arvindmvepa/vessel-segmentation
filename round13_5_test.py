...
if __name__ == '__main__':
    ...
    EXPERIMENTS_DIR_PATH = "/root/vessel-segmentation4/experiments13_5_test_eval"
    ...
    first_index = int(math.ceil(num_jobs/6.0))*4
    last_index = int(math.ceil(num_jobs/6.0))*5
