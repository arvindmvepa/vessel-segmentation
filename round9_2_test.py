...
if __name__ == '__main__':
    ...
    EXPERIMENTS_DIR_PATH = "/root/vessel-segmentation1/experiments9_2_test_eval"
    ...
    seqs = [iaa.Sequential([iaa.Affine(rotate=(-10, 10), mode='constant', cval=0, name="rotate_small")]), None]
