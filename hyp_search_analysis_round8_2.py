...
if __name__ == '__main__':
    EXPERIMENTS_DIR_PATH = "/Users/arvind.m.vepa/Documents/vessel segmentation/round8_2/overall results"
    OUTPUT_DIR_PATH = "/Users/arvind.m.vepa/Documents/vessel segmentation/round8_2/overall output"
    TOP_EXPERIMENTS_DIR_PATH = "/Users/arvind.m.vepa/Documents/vessel segmentation/round8_2/top overall results"
    TOP_OUTPUT_DIR_PATH = "/Users/arvind.m.vepa/Documents/vessel segmentation/round8_2/top overall output"

    jobs = analyze(EXPERIMENTS_DIR_PATH=EXPERIMENTS_DIR_PATH, OUTPUT_DIR_PATH=OUTPUT_DIR_PATH,
                   get_hyp_opts=get_hyp_opts, rt_jobs_score=.97, relevant_hyps=("seqs","num_epochss"),
                   n_metric_intervals=40)
    ...
    """
    analyze(EXPERIMENTS_DIR_PATH=TOP_EXPERIMENTS_DIR_PATH, OUTPUT_DIR_PATH=TOP_OUTPUT_DIR_PATH,
            get_hyp_opts=get_hyp_opts, relevant_hyps=("seqs", "num_epochss"), n_metric_intervals=40)
