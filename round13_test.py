...
if __name__ == '__main__':
    ...
    EXPERIMENTS_DIR_PATH = "C:\\vessel-segmentation\\experiments13_test_eval"
    ...
    for job_opts in job_opts_all[:int(num_jobs/2)]:
        ...
        job.run_single_model(WRK_DIR_PATH=WRK_DIR_PATH, early_stopping=False, early_stopping_metric="auc",
                   ...
                   viz_layer_epoch_freq=viz_layer_epoch_freq, n_epochs=n_epochs, gpu_device='/gpu:1', **job_kwargs)
