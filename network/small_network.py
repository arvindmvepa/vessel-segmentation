    ...
    def __init__(self, weight_init=None, layer_params=None, act_fn="lrelu", layers=None, **kwargs):
        ...
        if layers == None:
            ...
            layers.append(Conv2d(kernel_size=self.layer_params['conv_4_1']['ks'],
                                 dilation=self.layer_params['conv_4_1']['dilation'], act_fn=act_fn, weight_init=weight_init,
            ...
            layers.append(Conv2d(kernel_size=self.layer_params['conv_4_2']['ks'],
                                 dilation=self.layer_params['conv_4_2']['dilation'], act_fn=act_fn, weight_init=weight_init,
