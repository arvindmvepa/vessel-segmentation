...
class LargeNetwork(Network):
    ...
    def __init__(self, weight_init=None, act_fn="lrelu", act_leak_prob=.2, batch_norm=True, layer_params=None,
        ...
        self.layer_params = {"conv_1_1":{"kernel_size":3, "dilation":1 , "output_channels":64, "keep_prob":1.0,
                             ...
                             "conv_4_1": {"kernel_size":3, "dilation":1 , "output_channels":512, "keep_prob":1.0,
                                          "batch_norm": batch_norm, "name": "conv_4_1"},
                             "conv_4_2": {"kernel_size":3, "dilation":1 , "output_channels":512, "keep_prob":1.0,
                                          "batch_norm": batch_norm, "name": "conv_4_2"},
                             "pool_4": {"kernel_size":2, "name": "pool_4"},
                             "conv_5_1": {"kernel_size":3, "dilation":1 , "output_channels":512, "keep_prob":1.0,
                                          "batch_norm": batch_norm, "name": "conv_5_1"},
                             "conv_5_2": {"kernel_size":3, "dilation":1 , "output_channels":512, "keep_prob":1.0,
                                          "batch_norm": batch_norm, "name": "conv_5_2"},
                             "pool_5": {"kernel_size":2, "name": "pool_5"},
                             "conv_6_1": {"kernel_size":7, "dilation":1 , "output_channels":4096, "keep_prob":1.0,
                                          "batch_norm": batch_norm, "name": "conv_6_1"},
                             "conv_6_2": {"kernel_size":1, "dilation":1 , "output_channels":4096, "keep_prob":1.0,
                                          "batch_norm": batch_norm, "name": "conv_6_2"},
                             "convt_7_1": {"kernel_size": 1, "dilation": 1, "output_channels": 4096, "keep_prob": 1.0,
                                           "batch_norm": batch_norm, "name": "convt_7_1"},
                             "convt_7_2": {"kernel_size": 7, "dilation": 1, "output_channels": 512, "keep_prob": 1.0,
                                           "batch_norm": batch_norm, "name": "convt_7_2"},
                             "up_8": {"kernel_size": 2, "add_to_input": True, "name": "up_8"},
                             "convt_8_1": {"kernel_size": 3, "dilation": 1, "output_channels": 512, "keep_prob": 1.0,
                                           "batch_norm": batch_norm, "name": "convt_8_1"},
                             "convt_8_2": {"kernel_size": 3, "dilation": 1, "output_channels": 512, "keep_prob": 1.0,
                                           "batch_norm": batch_norm, "name": "convt_8_2"},
                             "up_9": {"kernel_size": 2, "add_to_input": True, "name": "conv_1_1"},
                             "convt_9_1": {"kernel_size": 3, "dilation": 1, "output_channels": 512, "keep_prob": 1.0,
                                           "batch_norm": batch_norm, "name": "convt_9_1"},
                             "convt_9_2": {"kernel_size": 3, "dilation": 1, "output_channels": 256, "keep_prob": 1.0,
                                           "batch_norm": batch_norm, "name": "convt_9_2"},
                             "up_10": {"kernel_size": 2, "add_to_input": True, "name": "up_10"},
                             "convt_10_1": {"kernel_size": 3, "dilation": 1, "output_channels": 256, "keep_prob": 1.0,
                                            "batch_norm": batch_norm, "name": "convt_10_1"},
                             "convt_10_2": {"kernel_size": 3, "dilation": 1, "output_channels": 128, "keep_prob": 1.0,
                                            "batch_norm": batch_norm, "name": "convt_10_2"},
                             "up_11": {"kernel_size": 2, "add_to_input": True, "name": "up_11"},
                             "convt_11_1": {"kernel_size": 3, "dilation": 1, "output_channels": 64, "keep_prob": 1.0,
                                            "batch_norm": batch_norm, "name": "convt_11_1"},
                             "up_12": {"kernel_size": 2, "add_to_input": True, "name": "up_12"},
                             "convt_12_1": {"kernel_size": 3, "dilation": 1, "output_channels": 1, "keep_prob": 1.0,
    ...
    def init_decoder(self, **kwargs):
        ...
        layers.append(ConvT2d(weight_init=self.weight_init, act_fn=None, **self.layer_params['convt_12_1']))
        self.decoder = layers