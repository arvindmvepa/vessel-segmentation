...
if __name__ == '__main__':
    ...
    EXPERIMENTS_DIR_PATH = "/root/vessel-segmentation1/experiments12_ens_test_eval"
    ...
    seq = iaa.Sequential([iaa.Affine(rotate=(-67.5, 67.5), mode='constant', cval=0, name="rotate")])
