...
if __name__ == '__main__':
    ...
    EXPERIMENTS_DIR_PATH = "C:\\vessel-segmentation\\check"
    ...
    job.run_single_model(WRK_DIR_PATH=WRK_DIR_PATH, early_stopping=False, early_stopping_metric="auc",
                         ...
                         weight_init=weight_init, act_fn=act_fn, act_leak_prob=act_leak_prob, seq=seq, hist_eq=hist_eq,
                         clahe_kwargs=clahe_kwargs, per_image_normalization=per_image_normalization,gamma=gamma,
                         gpu_device='/gpu:1')