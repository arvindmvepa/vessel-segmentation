...
if __name__ == '__main__':
    ...
    EXPERIMENTS_DIR_PATH = MAIN_DIR + DIR_EXT + "/"+str(overall_results)
    OUTPUT_DIR_PATH = MAIN_DIR + DIR_EXT + "/"+str(overall_output)
    TOP_EXPERIMENTS_DIR_PATH = MAIN_DIR + DIR_EXT + "/" +str(top_overall_results)
    TOP_OUTPUT_DIR_PATH = MAIN_DIR + DIR_EXT + "/" +str(top_overall_output)
